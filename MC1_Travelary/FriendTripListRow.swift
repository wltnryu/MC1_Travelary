...
struct FriendTripListRow: View {
    var tripInfoData: F_TripInfo
        ...
        ScrollView(.vertical, showsIndicators: false) {
            ...
            VStack(alignment: .leading) {
                Text(tripInfoData.title)
                    ...
                    .padding(.bottom, 1) // 여기서 간격을 조정합니다.
...
struct FriendTripListRow_Previews: PreviewProvider {
    static var previews: some View {
        FriendTripListRow(tripInfoData: F_TripInfo(title: "Sample Title", subtitle: "Sample Subtitle", heartNum: "10", tag: ["#tag1", "#tag2"], imageArray: ["Image1", "Image2"]))
    }
}
